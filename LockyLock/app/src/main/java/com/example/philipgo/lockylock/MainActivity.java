package com.example.philipgo.lockylock;
...
public class MainActivity extends AppCompatActivity {
    ...
    private final String DEVICE_ADDRESS = "00:20:12:08:58:44"; //MAC Address of Bluetooth Module
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lock_state_btn.setOnClickListener(new View.OnClickListener() {
           @Override
            ...
            if(connected == false)
            {
                Toast.makeText(getApplicationContext(), "Please establish a connection with the bluetooth locky locks first", Toast.LENGTH_SHORT).show();
            }
            else
            {
                command = "1";
